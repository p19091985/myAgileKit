...
def main():
    parser = argparse.ArgumentParser(description='Remove marcações de citação de arquivos de texto ou pastas.', formatter_class=argparse.RawTextHelpFormatter)
    parser.add_argument('-p', '--pasta', help='Opcional: O caminho para a PASTA a ser limpa recursivamente.')
    parser.add_argument('arquivo_entrada', nargs='?', help='O caminho para o ARQUIVO que será limpo (usado se --pasta não for especificado).')
